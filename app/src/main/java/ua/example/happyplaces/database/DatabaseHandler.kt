package ua.example.happyplaces.database
...
class DatabaseHandler(context: Context) :
    ...
    fun getHappyPlacesList(): ArrayList<HappyPlaceModel> {
        ...
        val selectQuery = "SELECT  * FROM $TABLE_HAPPY_PLACE ORDER BY $KEY_DATE" // Database select query
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    val dateParts = cursor.getString(cursor.getColumnIndex(KEY_DATE)).split('-')
